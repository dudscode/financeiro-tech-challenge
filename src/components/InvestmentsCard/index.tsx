...
export const InvestmentsCard = ({ title = "Investimentos", total = '50.000.00', rendaVariavel = '14.000,00', rendaFixa = '36.000,00' }) => {
    ...
    return (
        <S.Container>
            ...
            <S.Paragraph txt='25px' type='valor' mb="32px">Total: R$ {total} </S.Paragraph>
            <S.ContainerRenda>
                <S.renda><S.Paragraph txt='16px' type='info'>Renda Fixa </S.Paragraph>
                    <S.Paragraph txt='20px'>R$ {rendaFixa} </S.Paragraph>
                </S.renda>
                <S.renda>
                    <S.Paragraph txt='16px' type='info'>Renda variável </S.Paragraph>
                    <S.Paragraph txt='20px'>R$ {rendaVariavel} </S.Paragraph>
                </S.renda>
            </S.ContainerRenda>
            <S.Paragraph txt='20px' type='titulo' mb="32px">Estatísticas</S.Paragraph>
